...
<<<<<<< HEAD
    ...
    status ENUM('Confirmado', 'Preparando', 'Enviado', 'Em Trânsito', 'Entregue', 'Cancelado') DEFAULT 'Confirmado',
    codigo_rastreamento VARCHAR(20),
    data_pedido TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (id_usuario) REFERENCES cadastro(id) ON DELETE CASCADE
);
